...
<img src="{{< baseurl >}}/images/hourly distr.png" style="width:auto;height=100%;display=block;" display = "block" title="Figure 1 - Hourly Distribution of Pick-Ups">
</div>
...
<div style="text-align: center; display: block;">
<img src="{{< baseurl >}}/images/week distr.png" style="width:auto;height=100%;display=block;" title="Figure 2 - Weekly Distribution of Pick-Ups">
</div>
...
<div style="text-align: center; display: block;">
<img src="{{< baseurl >}}/images/month distr.png" style="width:auto;height=100%;display=block;" title="Figure 3 - Monthly Distribution of Pick-Ups">
</div>
...
<div style="text-align: center; display: block;">
<iframe src = {{< baseurl >}}/html/Lineplot_taxi.html style="width: 900px; height: 600px; left.-140px;display=block;" frameborder="0" scrolling="no" onload="resizeIframe(this)"  title="Figure 4 - Hourly Distributions by Day Taxis"> </iframe>
</div>
